...
A seleção do microcontrolador ESP32 justifica-se por sua capacidade de processamento dual-core de 32 bits, dimensões compactas, suporte nativo a modulação por largura de pulso (PWM) por hardware e excelente relação custo-benefício \cite{espressif2023esp32}. Ao empregar componentes comerciais prontos para uso (\textit{COTS}), o projeto visa demonstrar a viabilidade técnica de uma tecnologia assistiva de código aberto e baixo custo, cujo valor de montagem seja acessível à realidade socioeconômica brasileira.
